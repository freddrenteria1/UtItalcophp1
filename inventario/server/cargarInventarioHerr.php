...
while($obj = mysqli_fetch_object($eje)){
    ...
    if($obj->codtipo == '03' || $obj->clase == 'SERVICIO DE ALQUILER'){
        ...
        $buscari = "SELECT ods, almacen, codigo, ubicacion, SUM(cant) as tot FROM  invplantaalm Where codigo = '$coditem' And ods='$ods' And almacen = 'Herramientas' And ubicacion = '$ubicacion' Group by codigo";
