...
$sql = "INSERT INTO activos VALUES('','$fecha','$ced','$nombres','$cargo','$ods','$ubicacion','$items','$observaciones','$archivo','$user')";
...
if(!$gent){
    ...
    for($i = 0; $i<$canti; $i++){
        ...
        $query2 = "INSERT INTO invactivos VALUES('','$fecha', $lastid, '$ced', '$nombres', '$cod', '$art', $cant, '$ods')";
