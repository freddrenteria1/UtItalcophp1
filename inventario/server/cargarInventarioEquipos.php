...
$query = "SELECT * FROM inventario Where codtipo = '03' Group by codigo";
...
while($obj = mysqli_fetch_object($eje)){
    ...
    $cons = "SELECT * FROM inventario Where codtipo = '03' AND cantidad > 0 GROUP BY ubicacion";
    ...
    while($rowu = mysqli_fetch_object($ejec)){
        ...
        if($ubi != 'AHLOGISTICA CENTRALALMACEN CENTRAL HTAS/EQUIPOS'){
            ...
            $buscari = "SELECT * FROM  inventario Where codigo = '$coditem' And cantidad > 0 And ubicacion = '$ubi'";
