...
$sql="INSERT INTO users VALUES('', '$empresa', '$nombres', '$user', '$clave', 'auditor', 'Inactivo')";
...
ini_set( 'display_errors', 1 );
    ...
    // Asunto
    $titulo = 'Registro Plataforma QAQC ODS 029 - UT Italco';
    ...
    <img src="https://utitalco.com/hv/img/logo_m.png" width="200px">
     <p>Datos del registro  en ODS 029 Aromáticos: <br><br>
    
        Nombres: ' .$nombres . '<br>
        Email: ' .$user . '<br><br><br>

        Link para activar Usuario: <a href="https://utitalco.com/calidad/029/admin.html">https://utitalco.com/calidad/029/admin.html</a>
