...
$cons = "SELECT * FROM asistenciasglobal Where fecha between '$finicio' And '$ffinal' and ods='$ods' group by fecha Order by fecha ASC";
...
while($obj = mysqli_fetch_object($eje)){
    ...
    $sql1 = "SELECT SUM(hht) as toth From asistenciasglobal Where fecha = '$fecha'  and ods='$ods' And detallepago = 'ECPXPLANTILLA' Group by fecha";
    ...
    $sql2 = "SELECT SUM(hht) as toth From asistenciasglobal Where fecha = '$fecha' and ods='$ods' And detallepago = 'ECPXFCIN' Group by fecha";
    ...
    $sql3 = "SELECT SUM(hht) as toth From asistenciasglobal Where fecha = '$fecha' and ods='$ods'  And detallepago = 'ECPXHSE' Group by fecha";
    ...
    $sql4 = "SELECT SUM(hht) as toth From asistenciasglobal Where fecha = '$fecha'  and ods='$ods' And detallepago = 'ECPXTARIFA' Group by fecha";
    ...
    $sql5 = "SELECT SUM(hht) as toth From asistenciasglobal Where fecha = '$fecha' and ods='$ods' And tiponomina = 'DIRECTO'  And detallepago = 'TRANSVERSAL' And acargo='ECOPETROL'  Group by fecha";
    ...
    $sql9 = "SELECT SUM(hht) as toth From asistenciasglobal Where fecha = '$fecha' and ods='$ods' And tiponomina = 'INDIRECTO'  And detallepago = 'TRANSVERSAL' And acargo='ECOPETROL'  Group by fecha";
    ...
    $sql6 = "SELECT SUM(hht) as toth From asistenciasglobal Where fecha = '$fecha' and ods='$ods' And tiponomina = 'DIRECTO' And detallepago = 'TRANSVERSAL' And acargo='ITALCO' Group by fecha";
    ...
    $sql7 = "SELECT SUM(hht) as toth From asistenciasglobal Where fecha = '$fecha' and ods='$ods' And tiponomina = 'INDIRECTO' And detallepago = 'TRANSVERSAL' And acargo='ITALCO' Group by fecha";
    ...
    $sql8 = "SELECT SUM(hht) as toth From asistenciasglobal Where fecha = '$fecha'  and ods='$ods' And detallepago = 'ECPXLOGISTICA' Group by fecha";
