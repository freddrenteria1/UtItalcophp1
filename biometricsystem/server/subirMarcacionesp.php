...
$excel='2022-06-21-Reporte de Marcaciones_JUNIO 21 dia1.csv';
    ...
    while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
        ...
        if ($numeroDeFila > 1) {
            ...
            if($fila[0] != ''){
                ...
                echo '<br>';
                echo 'Hora marca ' . $hora;
                echo '<br>';
                echo 'tipo Marca orginal ' . $tipom;
                echo '<br>';
                echo 'tipo real ' . $tipo;
                echo '<br>';
