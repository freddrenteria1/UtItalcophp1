...
function siguiente(){
  ...
  if(arrayRespP1.length < 26){
    ...
    localStorage.setItem('fotoprueba', canvas.toDataURL("image/png"))
    localStorage.setItem('arrayRespP1',JSON.stringify(arrayRespP1))
    location = "parte2.html"
  }

  console.log(arrayRespP1)
