...
function cargarDatos(){
    ...
    $.post(server + 'cargarEntrada.php', {id:idEnt},
    function(resp) {
        arrayDatos = resp
        console.log(resp)
        ...
        $('#doc').html(arrayDatos.documento)
        $('#insp').html(arrayDatos.inspeccion)

        if(arrayDatos.estado == 'Conforme'){
            
            document.getElementById("estadoconf").checked = true;
        }else{
             
            document.getElementById("estadonoconf").checked = true;
        }

        $('#acciones').html(arrayDatos.acciones)
        $('#almac').html(arrayDatos.almacenamiento)
        $('#obsgen').html(arrayDatos.observaciones)
        ...
        $('#aprobado').val(arrayDatos.aprobado)
        ...
        for(var i=0; i<arrayItems.length; i++){
            ...
            <tr>
                ...
                <td>${arrayItems[i].observacion}</td>
