...
// Creamos y abrimos un archivo zip temporal
 $zip->open("eyectores.zip",ZipArchive::CREATE);
...
$zip->close();
 ...
 header("Content-disposition: attachment; filename=eyectores.zip");
 // leemos el archivo creado
 readfile('eyectores.zip');
 // Por último eliminamos el archivo temporal creado
//  unlink('eyectores.zip');//Destruye el archivo temporal
