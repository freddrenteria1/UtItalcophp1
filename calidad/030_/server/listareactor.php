...
// Creamos y abrimos un archivo zip temporal
 $zip->open("reactor.zip",ZipArchive::CREATE);
...
$zip->close();
 ...
 header("Content-disposition: attachment; filename=reactor.zip");
 // leemos el archivo creado
 readfile('reactor.zip');
 // Por último eliminamos el archivo temporal creado
//  unlink('reactor.zip');//Destruye el archivo temporal
