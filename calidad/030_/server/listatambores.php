...
// Creamos y abrimos un archivo zip temporal
 $zip->open("tambores.zip",ZipArchive::CREATE);
...
$zip->close();
 ...
 header("Content-disposition: attachment; filename=tambores.zip");
 // leemos el archivo creado
 readfile('tambores.zip');
 // Por último eliminamos el archivo temporal creado
//  unlink('tambores.zip');//Destruye el archivo temporal
