...
while($row = mysqli_fetch_object($exito)){
    ...
    $cons1 = "SELECT * FROM os94 WHERE " . $campo . " LIKE '%\"firmaut\":\"data:image/png;%'";
    $ejec1 = mysqli_query($conexion, $cons1);
    $enc1 = mysqli_num_rows($ejec1);

    $sumfirmaut += $enc1;

    $cons2 = "SELECT * FROM os94 WHERE " . $campo . " LIKE '%\"firmaec\":\"data:image/png;%'";
