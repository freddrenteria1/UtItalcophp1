...
// Creamos y abrimos un archivo zip temporal
 $zip->open("regenerador.zip",ZipArchive::CREATE);
...
$zip->close();
 ...
 header("Content-disposition: attachment; filename=regenerador.zip");
 // leemos el archivo creado
 readfile('regenerador.zip');
 // Por último eliminamos el archivo temporal creado
//  unlink('regenerador.zip');//Destruye el archivo temporal
