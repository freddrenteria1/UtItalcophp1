...
if($cont == 0){
    ...
    $sql = "UPDATE users SET empresa  = '$empresa',  nombres='$nombres', email='$user', clave='$clave', documento = '$registro', firma = '$firma'";
    $exito = mysqli_query($conexion, $sql);
}
...
ini_set( 'display_errors', 1 );
    ...
    // Asunto
    $titulo = 'Registro Plataforma QAQC ODS 030 - UT Italco';
    ...
    <img src="https://utitalco.com/hv/img/logo_m.png" width="200px">
     <p>Datos del registro  en ODS 030 Aromáticos: <br><br>
    
        Nombres: ' .$nombres . '<br>
        Email: ' .$user . '<br><br><br>

        Link para activar Usuario: <a href="https://utitalco.com/calidad/030/admin.html">https://utitalco.com/calidad/030/admin.html</a>
