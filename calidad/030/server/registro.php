...
<body>
    ...
    <div class="">
        ...
        <div class="contenedor2">
            <div class="elemento">
                ...
                <h5 class="text-center mt-3 ">PLATAFORMA DIGITAL  GESTIÓN DE CALIDAD  ODS 030 U-2100 <hr> REGISTRO USUARIO<hr>
                    ...
                    <div style="width: 500px; margin: auto;">
                        ...
                        <div class="mt-3">
                            <center>
                                <h5>
                                    <button class="p-1 btn-success" onclick="guardar()">Guardar</button>
                                <a href="index.php"><button class="p-1 btn-dark" >Ingresar</button></a>
                                </h5>
                            </center>
                        </div>
    ...
    <script>
        var odsq = null
        var url = "https://utitalco.com/calidad/030/server/";
