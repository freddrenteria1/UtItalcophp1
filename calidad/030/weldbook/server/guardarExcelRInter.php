...
while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
    ...
    if ($numeroDeFila > 2) {
        ...
        if($fila[0] != ''){
            ...
            $query = "INSERT INTO resinter VALUES('',  '$fila[0]',  '$fila[1]', '$fila[2]', '$fila[3]', '$fila[4]', '$fila[5]', '$fila[6]', '$fila[7]', '$fila[8]', '$fila[9]', '$fila[10]', '$fila[11]', '$fila[12]', '$fila[13]', '$fila[14]')";
...
$sql = "INSERT INTO bitacoraresinter VALUES('', '$user', '$fecha', '$excel')";
