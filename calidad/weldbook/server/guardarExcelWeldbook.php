...
while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
    ...
    if ($numeroDeFila > 11) {
        ...
        if($fila[5] != ''){
            ...
            $query = "INSERT INTO datosw VALUES('', '$fila[1]', '$fila[2]', '$fila[3]', '$fila[4]', '$fila[5]', '$fila[6]', '$fila[7]', '$fila[8]', '$fila[9]', '$fila[10]', '$fila[11]', '$fila[12]', '$fila[13]', '$fila[14]', '$fila[15]', '$fila[16]', '$fila[17]', '$fila[18]', '$fila[19]', '$fila[20]', '$fila[21]', '$fila[22]', '$fila[23]', '$fila[24]', '$fila[25]', '$fila[26]', '$fila[27]', '$fila[28]', '$fila[29]', '$fila[30]', '$fila[31]', '$fila[32]', '$fila[33]', '$fila[34]', '$fila[35]', '$fila[36]', '$fila[37]', '$fila[38]', '$fila[39]', '$fila[40]', '$fila[41]', '$fila[42]', '$fila[43]', '$fila[44]', '$fila[45]', '$fila[46]', '$fila[47]', '$fila[48]', '$fila[49]', '$fila[50]', '$fila[51]', '$fila[52]', '$fila[53]', '$fila[54]', '$fila[55]', '$fila[56]', '$fila[57]', '$fila[58]')";
            ...
            $query = "INSERT INTO datoswp VALUES('', '$fila[1]', '$fila[2]', '$fila[3]', '$fila[4]', '$fila[5]', '$fila[6]', '$fila[7]', '$fila[8]', '$fila[9]', '$fila[10]', '$fila[11]', '$fila[12]', '$fila[13]', '$fila[14]', '$fila[15]', '$fila[16]', '$fila[17]', '$pulgadas', $pulg, '$fila[19]', '$fila[20]', '$fila[21]', '$fila[22]', '$fila[23]', '$fila[24]', '$fila[25]', '$fila[26]', '$fila[27]', '$fila[28]', '$fila[29]', '$fila[30]', '$fila[31]', '$fila[32]', '$fila[33]', '$fila[34]', '$fila[35]', '$fila[36]', '$fila[37]', '$fila[38]', '$fila[39]', '$fila[40]', '$fila[41]', '$fila[42]', '$fila[43]', '$fila[44]', '$fila[45]', '$fila[46]', '$fila[47]', '$fila[48]', '$fila[49]', '$fila[50]', '$fila[51]', '$fila[52]', '$fila[53]', '$fila[54]', '$fila[55]', '$fila[56]', '$fila[57]', '$fila[58]')";
            $eje = mysqli_query($conexion, $query);
