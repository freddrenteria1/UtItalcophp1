...
<head>
    ...
    <meta http-equiv="Refresh" content="0;url=https://utitalco.online/calidad/032/index.html">
    ...
    <style>
        ...
        body {
            ...
            background-image: url("img/fondo_n.jpg"); /* The image used */
...
<body>
    ...
    <div class="">
        ...
        <div class="contenedor2">
            <div class="elemento">
                ...
                <h5 class="text-center mt-3 ">PLATAFORMA DIGITAL <br> GESTIÓN DE CALIDAD <br> ODS 032 AZUFRE lll <br><br>
    ...
    <script>
        var odsq = null
        var url = "https://utitalco.com/calidad/032/server/";
