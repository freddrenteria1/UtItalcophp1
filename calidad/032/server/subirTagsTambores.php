    ...
    while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
        ...
        if ($numeroDeFila > 1) {
            ...
            if($fila[0] != ''){
                ...
                $query = "INSERT INTO tags VALUES('', '028', 'U-2500', 'DEMEX', 'ESTÁTICO', 'TAMBORES', 'ALISTAMIENTO', '', '$fila[4]', 'OS80')";
                $eje = mysqli_query($conexion, $query);

                $query2 = "INSERT INTO os80 VALUES('', 'U-2500', '$fila[3]', 'DEMEX', '028', '$fila[4]', '$fila[5]','$fila[6]', '', '','','','','','','','','','')";
