...
while($row = mysqli_fetch_object($exito)){
    ...
    $cons1 = "SELECT * FROM os97f WHERE " . $campo . " LIKE '%\"firmaut\":\"data:image/jpg;%'";
    $ejec1 = mysqli_query($conexion, $cons1);
    $enc1 = mysqli_num_rows($ejec1);

    $sumfirmaut += $enc1;

    $cons1 = "SELECT * FROM os97f WHERE " . $campo . " LIKE '%\"firmaut\":\"data:image/jpeg;%'";
    $ejec1 = mysqli_query($conexion, $cons1);
    $enc1 = mysqli_num_rows($ejec1);
    ...
    $cons2 = "SELECT * FROM os97f WHERE " . $campo . " LIKE '%\"firmaec\":\"data:image/jpg;%'";
    $ejec2 = mysqli_query($conexion, $cons2);
    $enc2 = mysqli_num_rows($ejec2);

    $sumfirmaec += $enc2;

    $cons2 = "SELECT * FROM os97f WHERE " . $campo . " LIKE '%\"firmaec\":\"data:image/jpeg;%'";
    $ejec2 = mysqli_query($conexion, $cons2);
    $enc2 = mysqli_num_rows($ejec2);
...
while($row = mysqli_fetch_object($exito)){
    ...
    $cons1 = "SELECT * FROM os95 WHERE " . $campo . " LIKE '%\"firmaut\":\"data:image/jpg;%'";
    $ejec1 = mysqli_query($conexion, $cons1);
    $enc1 = mysqli_num_rows($ejec1);

    $sumfirmaut += $enc1;

    $cons1 = "SELECT * FROM os95 WHERE " . $campo . " LIKE '%\"firmaut\":\"data:image/jpeg;%'";
    $ejec1 = mysqli_query($conexion, $cons1);
    $enc1 = mysqli_num_rows($ejec1);
    ...
    $cons2 = "SELECT * FROM os95 WHERE " . $campo . " LIKE '%\"firmaec\":\"data:image/jpg;%'";
    $ejec2 = mysqli_query($conexion, $cons2);
    $enc2 = mysqli_num_rows($ejec2);

    $sumfirmaec += $enc2;

    $cons2 = "SELECT * FROM os95 WHERE " . $campo . " LIKE '%\"firmaec\":\"data:image/jpeg;%'";
    $ejec2 = mysqli_query($conexion, $cons2);
    $enc2 = mysqli_num_rows($ejec2);
...
while($row = mysqli_fetch_object($exito)){
    ...
    $cons1 = "SELECT * FROM os96 WHERE " . $campo . " LIKE '%\"firmaut\":\"data:image/jpg;%'";
    $ejec1 = mysqli_query($conexion, $cons1);
    $enc1 = mysqli_num_rows($ejec1);

    $sumfirmaut += $enc1;

    $cons1 = "SELECT * FROM os96 WHERE " . $campo . " LIKE '%\"firmaut\":\"data:image/jpeg;%'";
    $ejec1 = mysqli_query($conexion, $cons1);
    $enc1 = mysqli_num_rows($ejec1);
    ...
    $cons2 = "SELECT * FROM os96 WHERE " . $campo . " LIKE '%\"firmaec\":\"data:image/jpg;%'";
    $ejec2 = mysqli_query($conexion, $cons2);
    $enc2 = mysqli_num_rows($ejec2);

    $sumfirmaec += $enc2;

    $cons2 = "SELECT * FROM os96 WHERE " . $campo . " LIKE '%\"firmaec\":\"data:image/jpeg;%'";
    $ejec2 = mysqli_query($conexion, $cons2);
    $enc2 = mysqli_num_rows($ejec2);
...
while($row = mysqli_fetch_object($exito)){
    ...
    $cons1 = "SELECT * FROM os97 WHERE " . $campo . " LIKE '%\"firmaut\":\"data:image/jpg;%'";
    $ejec1 = mysqli_query($conexion, $cons1);
    $enc1 = mysqli_num_rows($ejec1);

    $sumfirmaut += $enc1;

    $cons1 = "SELECT * FROM os97 WHERE " . $campo . " LIKE '%\"firmaut\":\"data:image/jpeg;%'";
    $ejec1 = mysqli_query($conexion, $cons1);
    $enc1 = mysqli_num_rows($ejec1);
    ...
    $cons2 = "SELECT * FROM os97 WHERE " . $campo . " LIKE '%\"firmaec\":\"data:image/jpg;%'";
    $ejec2 = mysqli_query($conexion, $cons2);
    $enc2 = mysqli_num_rows($ejec2);

    $sumfirmaec += $enc2;

    $cons2 = "SELECT * FROM os97 WHERE " . $campo . " LIKE '%\"firmaec\":\"data:image/jpeg;%'";
    $ejec2 = mysqli_query($conexion, $cons2);
    $enc2 = mysqli_num_rows($ejec2);
...
$totalecoplan = $totalpuntosec + $totalingec + $totallazosec + $totalmisctubec;
