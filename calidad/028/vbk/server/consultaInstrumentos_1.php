...
//consulta VÁLVULAS DE CONTROL CUSTODIA OS160
$totalecp = 3;
$totalut = 3;

$cons = "SELECT * FROM os160 WHERE familia = 'VÁLVULAS DE CONTROL'";
$ejec = mysqli_query($conexion, $cons);
$cant = mysqli_num_rows($ejec);
...
$cons3 = "SELECT * FROM os160 WHERE familia = 'VÁLVULAS DE CONTROL'";
$ejec3 = mysqli_query($conexion, $cons3);
$enc3 = mysqli_num_rows($ejec3);
...
while($row = mysqli_fetch_object($ejec3)){
    ...
    $cons4 = "SELECT * FROM os160 WHERE tag = '$tag' AND familia = 'VÁLVULAS DE CONTROL'";
    $ejec4 = mysqli_query($conexion, $cons4);
