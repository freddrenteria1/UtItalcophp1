...
while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
    ...
    if ($numeroDeFila > 5) {
        ...
        if($fila[2] != ''){
            ...
            $query = "INSERT INTO ccvalvulas VALUES('', $fila[1], '$tag', '$fila[3]', '$fila[4]', '$fila[5]', '$fila[6]', '$fila[7]', '$fila[8]', '$fila[9]', '$fila[10]')";
...
$sql = "INSERT INTO bitacoraccvalvulas VALUES('', '$user', '$fecha', '$excel')";
