...
ini_set( 'display_errors', 1 );
    ...
    // Asunto
    $titulo = 'Registro Plataforma QAQC ODS 028 - UT Italco';
    ...
    <img src="https://utitalco.com/hv/img/logo_m.png" width="200px">
     <p>Datos del registro  en ODS 028 Aromáticos: <br><br>
    
        Nombres: ' .$nombres . '<br>
        Email: ' .$user . '<br><br><br>

        Link para activar Usuario: <a href="https://utitalco.com/calidad/028/admin.html">https://utitalco.com/calidad/028/admin.html</a>
