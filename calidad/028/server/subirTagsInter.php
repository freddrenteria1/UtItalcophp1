    ...
    while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
        ...
        if ($numeroDeFila > 1) {
            ...
            if($fila[0] != ''){
                ...
                $query = "INSERT INTO tags VALUES('', '028', 'U-2500', 'DEMEX', 'ESTÁTICO', 'INTERCAMBIADORES', 'ALISTAMIENTO', '', '$fila[4]', 'OS38')";
                $eje = mysqli_query($conexion, $query);

                $query2 = "INSERT INTO os38 VALUES('', 'U-2500', '$fila[3]', 'DEMEX', '028', '$fila[4]','$fila[3]', '$fila[5]', '$fila[6]', '$fila[7]', '$fila[8]', '$fila[9]','','','','','','','','','','','','','')";
