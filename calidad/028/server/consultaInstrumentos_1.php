...
//consulta SERVOMOTORES CUSTODIA OS88
$totalecp = 3;
$totalut = 2;

$cons = "SELECT * FROM os88 WHERE familia = 'SERVOMOTORES'";
$ejec = mysqli_query($conexion, $cons);
$cant = mysqli_num_rows($ejec);
...
$cons3 = "SELECT * FROM os88 WHERE familia = 'SERVOMOTORES'";
$ejec3 = mysqli_query($conexion, $cons3);
$enc3 = mysqli_num_rows($ejec3);
...
while($row = mysqli_fetch_object($ejec3)){
    ...
    $cons4 = "SELECT * FROM os88 WHERE tag = '$tag' AND familia = 'SERVOMOTORES'";
    $ejec4 = mysqli_query($conexion, $cons4);
...
$datos = array(
    ...
    'tagsServoCusto'=>$tagsServoCusto,
    'consServoCusto'=>$consServoCusto,
    'tagsServoCusto89'=>$tagsServoCusto89,
    'consServoCusto89'=>$consServoCusto89,
    'tagsServoCusto160'=>$tagsServoCusto160,
    'consServoCusto160'=>$consServoCusto160,
