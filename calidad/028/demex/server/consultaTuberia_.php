...
while($obj = mysqli_fetch_object($ejec3)){
    ...
    if($tag == 'A-28698'  || $tag == 'A-28699'  ||  $tag == 'A-27609'  || $tag == 'A-27565' ){
        $totalpuntosut1 = 2;
        $totalpuntosec1 =2;
    }
...
while($obj = mysqli_fetch_object($ejec3)){
    ...
    if($tag == '21053' || $tag == '21052'  || $tag == '18052'  || $tag == '21006'  || $tag == '18050'  || $tag == '18122'  || $tag == '21023'  || $tag == '21024' ){
        $totalingec1 = 6;
    }else{
        $totalingec1 = 7;
    }
...
$cons3 = "SELECT * FROM osMiscTub GROUP BY  isometrico";
$ejec3 = mysqli_query($conexion, $cons3);
$enc3 = mysqli_num_rows($ejec3);
...
while($obj = mysqli_fetch_object($ejec3)){
    ...
    $totalmisctubut1 = 0;  
        ...
        $cons1 = "SELECT * FROM osMiscTub WHERE  isometrico = '$tag' "  ;
        $ejec1 = mysqli_query($conexion, $cons1);
    ...
    $tagsmisctub[] = array(
        'tag'=>$tag,
        'totalfirmasutplan'=>$totalmisctubut1,
        'totalfirmasecpplan'=>$totalmisctubec1,
        'totalfimasuteje'=>$sumfirmaut,
        'totalfirmaseceje'=> $sumfirmaec,
        'totalfirmasplan'=>$totalmisctubut1 + $totalmisctubec1,
        'totalfirmaseje'=>$sumfirmaut + $sumfirmaec,
        'firmasfaltantes'=>($totalmisctubut1 + $totalmisctubec1)-($sumfirmaut+$sumfirmaec)
    );
...
$cons3 = "SELECT * FROM osMiscInst GROUP BY  isometrico";
$ejec3 = mysqli_query($conexion, $cons3);
$enc3 = mysqli_num_rows($ejec3);
...
while($obj = mysqli_fetch_object($ejec3)){
    ...
    $totalmiscinstut1 = 0;  
        ...
        $cons1 = "SELECT * FROM osMiscInst WHERE  isometrico = '$tag' "  ;
        $ejec1 = mysqli_query($conexion, $cons1);
    ...
    $tagsmiscinst[] = array(
        'tag'=>$tag,
        'totalfirmasutplan'=>$totalmiscinstut1,
        'totalfirmasecpplan'=>$totalmiscinstec1,
        'totalfimasuteje'=>$sumfirmaut,
        'totalfirmaseceje'=> $sumfirmaec,
        'totalfirmasplan'=>$totalmiscinstut1 + $totalmiscinstec1,
        'totalfirmaseje'=>$sumfirmaut + $sumfirmaec,
        'firmasfaltantes'=>($totalmiscinstut1 + $totalmiscinstec1)-($sumfirmaut+$sumfirmaec)
    );
...
$datos = array(
    ...
    'lazos'=>$tagslazos,
    'miscelaneostub'=>$tagsmisctub,
    'miscelaneosinst'=>$tagsmiscinst
);
