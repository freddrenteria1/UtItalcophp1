...
$sql="SELECT COUNT(*) AS totjuntbwr FROM datosw WHERE fecha != '' AND tipojunta = 'BW'";
$exito=mysqli_query($conexion, $sql);
...
if($enc!=0){
    while($row = mysqli_fetch_object($exito)){
        if($row->rxpreresultado == 'RECHAZADA' OR $row->utpresultado == 'RECHAZADA'){
            $totjuntasbwr++;
        }
    }    
}
...
$sql="SELECT COUNT(*) AS totjuntbwr FROM datosw WHERE fecha != '' AND tipojunta = 'SW'";
$exito=mysqli_query($conexion, $sql);
...
$pordef = round($totjuntasrechazadas/$totjuntas, 2);


$sql="SELECT * FROM infdef WHERE juntasoldador = 'RECHAZADA'";
$exito=mysqli_query($conexion, $sql);
