...
$exito=mysqli_query($conexion, $sql);
            ...
            $sqlp="SELECT especialidad, equipo, lugar, pulgadas, SUM(cantw1) AS juntasp, SUM(pulgdiam) as pulgadasp, COUNT(*) as cant   FROM datoswp GROUP BY pulgadas ORDER BY pulgdiam";   
            ...
            while($objp = mysqli_fetch_object($exitop)){
                ...
                $sqlpe="SELECT * FROM datoswp WHERE pulgadas = '$pulgd'";   
