...
$totalequipos = $cantpuntos + $cantingenierias + $cantlazos;
$totalitalcoplan = $totalpuntosut + $totalingut + $totallazosut;
$totalecoplan = $totalpuntosec + $totalingec + $totallazosec;
$totalitalcoeje = $totalpuntosuteje + $totalinguteje + $totallazosuteje;
$totalecoeje = $totalpuntoseceje + $totalingeceje + $totallazoseceje;
