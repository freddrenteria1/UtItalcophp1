const API = "https://utitalco.com/calidad/033/alistamiento/server/";
...
const app = Vue.createApp({
  ...
  methods: {
    ...
    async cargarDatos() {
      ...
      try {
        const response = await fetch(API + "consultaEstaticos_Inter.php");
        ...
        this.arrayIntercambiadores = data.intercambiadores;
