...
$sql="SELECT * FROM os2224 WHERE ods='$ods' AND tag = '$tag'";
...
$obj = mysqli_fetch_object($exito);
    $datos = array(
        ...
        'limpieza_zona4'=>$obj->limpieza_zona4,
        'limpieza_zona5'=>$obj->limpieza_zona5,
        ...
        'ejecucion_zona4'=>$obj->ejecucion_zona4,
        'ejecucion_zona5'=>$obj->ejecucion_zona5,
        ...
        'liberacion_zona4_int'=>$obj->liberacion_zona4_int,
        'liberacion_zona4_ext'=>$obj->liberacion_zona4_ext,
        'liberacion_zona5_int'=>$obj->liberacion_zona5_int,
        'liberacion_zona5_ext'=>$obj->liberacion_zona5_ext,
        'prueba_goteo'=>$obj->prueba_goteo,
        'armado'=>$obj->armado,
        'prueba_distri'=>$obj->prueba_distri,
        'cierre'=>$obj->cierre,
