...
// Creamos y abrimos un archivo zip temporal
 $zip->open("miscinst.zip",ZipArchive::CREATE);
...
$zip->close();
 ...
 header("Content-disposition: attachment; filename=miscinst.zip");
 // leemos el archivo creado
 readfile('miscinst.zip');
 // Por último eliminamos el archivo temporal creado
//  unlink('miscinst.zip');//Destruye el archivo temporal
