...
$sql = "DELETE FROM ccplaterales WHERE fechacargue = '$fechacargue'";
$exit = mysqli_query($conexion, $sql);

$sql = "DELETE FROM ccppiso WHERE fechacargue = '$fechacargue'";
$exit = mysqli_query($conexion, $sql);

$sql = "DELETE FROM ccpfrontal WHERE fechacargue = '$fechacargue'";
$exit = mysqli_query($conexion, $sql);

$sql = "DELETE FROM ccptecho WHERE fechacargue = '$fechacargue'";
$exit = mysqli_query($conexion, $sql);

$sql = "DELETE FROM ccppantalla WHERE fechacargue = '$fechacargue'";
$exit = mysqli_query($conexion, $sql);
...
while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
    ...
    if ($numeroDeFila == 8 || $numeroDeFila == 18 ||  $numeroDeFila == 24 ||  $numeroDeFila == 34 ||  $numeroDeFila == 44 ||  $numeroDeFila == 45 ||  $numeroDeFila == 46) {
        ...
        if($fila[1] != ''){
            ...
            $query = "INSERT INTO ccplaterales VALUES('', $fila[1], '$fila[2]', '$fila[7]', '$fila[8]', '$fila[9]', '$fila[10]', '$fechacargue', '$fila[11]', '$fila[13]', '$fechacargue')";
    ...
    if ($numeroDeFila == 51 || $numeroDeFila == 61 ||  $numeroDeFila == 67 ||  $numeroDeFila == 77 ||  $numeroDeFila == 87 ||  $numeroDeFila == 90 ||  $numeroDeFila == 99) {
        ...
        if($fila[1] != ''){
            ...
            $query = "INSERT INTO ccppiso VALUES('', $fila[1], '$fila[2]', '$fila[7]', '$fila[8]', '$fila[9]', '$fila[10]', '$fila[12]', '$fila[11]', '$fila[13]', '$fechacargue')";
            $eje = mysqli_query($conexion, $query);
    ...
    if ($numeroDeFila == 114 || $numeroDeFila == 124 ||  $numeroDeFila == 130 ||  $numeroDeFila == 140 ||  $numeroDeFila == 150 ||  $numeroDeFila == 153 ||  $numeroDeFila == 162) {
        ...
        if($fila[1] != ''){
            ...
            $query = "INSERT INTO ccpfrontal VALUES('', $fila[1], '$fila[2]', '$fila[7]', '$fila[8]', '$fila[9]', '$fila[10]', '$fila[12]', '$fila[11]', '$fila[13]', '$fechacargue')";
            $eje = mysqli_query($conexion, $query);
    ...
    if ($numeroDeFila == 177 || $numeroDeFila == 187 ||  $numeroDeFila == 193 ||  $numeroDeFila == 203 ||  $numeroDeFila == 213 ||  $numeroDeFila == 216 ||  $numeroDeFila == 225) {
        ...
        if($fila[1] != ''){
            ...
            $query = "INSERT INTO ccptecho VALUES('', $fila[1], '$fila[2]', '$fila[7]', '$fila[8]', '$fila[9]', '$fila[10]', '$fila[12]', '$fila[11]', '$fila[13]', '$fechacargue')";
            $eje = mysqli_query($conexion, $query);
    ...
    if ($numeroDeFila == 240 || $numeroDeFila == 250 ||  $numeroDeFila == 256 ||  $numeroDeFila == 266 ||  $numeroDeFila == 276 ||  $numeroDeFila == 279 ||  $numeroDeFila == 288) {
        ...
        if($fila[1] != ''){
            ...
            $query = "INSERT INTO ccppantalla VALUES('', $fila[1], '$fila[2]', '$fila[7]', '$fila[8]', '$fila[9]', '$fila[10]', '$fila[12]', '$fila[11]', '$fila[13]', '$fechacargue')";
            $eje = mysqli_query($conexion, $query);
