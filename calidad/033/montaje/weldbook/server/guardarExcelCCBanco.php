...
$sql = "DELETE FROM ccbanco WHERE fecha = '$fechacargue'";
...
while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
    ...
    if ($numeroDeFila == 7 || $numeroDeFila == 8 ||  $numeroDeFila == 9 ||  $numeroDeFila == 19 ||  $numeroDeFila == 29 ||  $numeroDeFila == 44 ||  $numeroDeFila == 55 ||  $numeroDeFila == 66 ||  $numeroDeFila == 75) {
        ...
        if($fila[1] != ''){
            ...
            $query = "INSERT INTO ccbanco VALUES('', $fila[1], '$fila[2]', '$fila[7]', '$fila[8]', '$fila[9]', '$fila[10]', '$fila[11]', '$fechacargue', '$fila[13]', '$fila[14]')";
