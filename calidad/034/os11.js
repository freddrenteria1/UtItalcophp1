...
function cargarDatos() {
    ...
    if (arrayDatos.mantenimiento != "") {
        ...
        $('#fecha6').val(arrayInfo[0].fechaecpi)
		$('#hora6').val(arrayInfo[0].horaecpi)
		$('#nombre6').val(arrayInfo[0].nombreecpi)

		if (arrayInfo[0].fechaecpi != "") {
			document.querySelector("#firma6").src = arrayInfo[0].firmaecpi;
			$('#firma6').removeClass('oculto')
			$('#btnFirmar6').hide()
		}

		$('#registro6').val(arrayInfo[0].registroecpi)
    ...
    if (arrayDatos.instalacion != "") {
		...
		$('#fecha7').val(arrayInfo[0].fechautsup)
		$('#hora7').val(arrayInfo[0].horautsup)
		$('#nombre7').val(arrayInfo[0].nombreutsup)

		if (arrayInfo[0].fechautsup != "") {
			document.querySelector("#firma7").src = arrayInfo[0].firmautsup;
			$('#firma7').removeClass('oculto')
			$('#btnFirmar7').hide()
		}

		$('#registro7').val(arrayInfo[0].registroutsup)


        $('#fecha8').val(arrayInfo[0].fechautqaqc)
		$('#hora8').val(arrayInfo[0].horautqaqc)
		$('#nombre8').val(arrayInfo[0].nombreutqaqc)

		if (arrayInfo[0].fechautqaqc != "") {
			document.querySelector("#firma8").src = arrayInfo[0].firmautqaqc;
			$('#firma8').removeClass('oculto')
			$('#btnFirmar8').hide()
		}

		$('#registro8').val(arrayInfo[0].registroutqaqc)



		$('#fecha9').val(arrayInfo[0].fechaecp)
		$('#hora9').val(arrayInfo[0].horaecp)
		$('#nombre9').val(arrayInfo[0].nombreecp)

		if (arrayInfo[0].fechaecp != "") {
			document.querySelector("#firma9").src = arrayInfo[0].firmaecp;
			$('#firma9').removeClass('oculto')
			$('#btnFirmar9').hide()
		}

		$('#registro9').val(arrayInfo[0].registroecp)
    ...
    if (arrayDatos.entrega != "") {
		...
		$('#fecha11').val(arrayInfo[0].fechaecp)
		$('#hora11').val(arrayInfo[0].horaecp)
		$('#nombre11').val(arrayInfo[0].nombreecp)

		if (arrayInfo[0].fechaecp != "") {
			document.querySelector("#firma11").src = arrayInfo[0].firmaecp;
			$('#firma11').removeClass('oculto')
			$('#btnFirmar11').hide()
		}

		$('#registro11').val(arrayInfo[0].registroecp)
...
function actDeconexion() {
	...
	$.post(server + 'act11Desconexion.php', {
		ods: odsq,
		tag: tag,
...
function actMantenimiento() {
    ...
    var fechaecpi = $('#fecha6').val()
	var horaecpi = $('#hora6').val()
	var nombreecpi = $('#nombre6').val()
	...
	var registroecpi = $('#registro6').val()
	...
	$.post(server + 'act11Mantenimiento.php', {
		ods: odsq,
		tag: tag,
		datos: JSON.stringify(arrayInfo)
	},
...
function actInstalacion() {
	...
	var registroutqaqc = $('#registro8').val()
    

	var fechaecp = $('#fecha9').val()
	var horaecp = $('#hora9').val()
	var nombreecp = $('#nombre9').val()
	...
	$.post(server + 'act11Instalacion.php', {
		ods: odsq,
		tag: tag,
		datos: JSON.stringify(arrayInfo)
	},
...
function actNormalizacion() {
	...
	var fechaecp = $('#fecha11').val()
	var horaecp = $('#hora11').val()
	var nombreecp = $('#nombre11').val()
	...
	var registroecp = $('#registro11').val()
	...
	$.post(server + 'act11Normalizacion.php', {
		ods: odsq,
		tag: tag,
		datos: JSON.stringify(arrayInfo)
	},
...
function adjuntar() {
	Swal.fire({
		...
		if (result.isConfirmed) {
			...
			$.ajax({
				url: server + 'guardarArchivo11.php',
				type: 'post',
				data: formData,
				contentType: false,
				processData: false,
