...
function pasarFirma() {
    if ($('#poldatos').prop('checked')) {
        ...
        if (idImagen >= 16 && idImagen <= 19) {
            actMantenimiento()
        }

        if (idImagen >= 20 && idImagen <= 34) {
            actComponentes()
        }

        if (idImagen >= 35 && idImagen <= 38) {
            actInternos()
        }

        if (idImagen == 39 || idImagen == 40) {
            actCierreM1()
        }

        if (idImagen == 41 || idImagen == 42) {
            actCierreM2()
        }

        if (idImagen >= 43 && idImagen <= 45) {
            actAjustes()
        }

        if (idImagen >= 46 && idImagen <= 48) {
            actTerminacion()
        }

        if (idImagen >= 49 && idImagen <= 51) {
            actAplicacion()
        }

        if (idImagen == 52 || idImagen == 53) {
            actEntrega()
        }
...
function cargarDatos() {
    ...
    //CARGUE DE DATOS MANTENIMIENTO

    if (arrayDatos.mantenimiento != "") {

		arrayInfo = JSON.parse(arrayDatos.mantenimiento)

		$('#itemmtto1').val(arrayInfo[0].itemmtto1)
		$('#itemmtto2').val(arrayInfo[0].itemmtto2)
		$('#itemmtto3').val(arrayInfo[0].itemmtto3)
		$('#itemmtto4').val(arrayInfo[0].itemmtto4)
        $('#itemmtto5').val(arrayInfo[0].itemmtto5)
        $('#itemmtto6').val(arrayInfo[0].itemmtto6)
        $('#itemmtto7').val(arrayInfo[0].itemmtto7)
        $('#itemmtto8').val(arrayInfo[0].itemmtto8)

		$('#cambioval1').val(arrayInfo[0].cambioval1)
        $('#cambioval2').val(arrayInfo[0].cambioval2)
        $('#cambioval3').val(arrayInfo[0].cambioval3)
        $('#cambioval4').val(arrayInfo[0].cambioval4)

		$('#fecha16').val(arrayInfo[0].fechautsup)
		$('#hora16').val(arrayInfo[0].horautsup)
		$('#nombre16').val(arrayInfo[0].nombreutsup)

		if (arrayInfo[0].fechautsup != "") {

            var firmaUsuario = buscarFirma(arrayInfo[0].registroutsup);

			document.querySelector("#firma16").src = firmaUsuario
			$('#firma16').removeClass('oculto')
			$('#btnFirmar16').hide()
		}

		$('#registro16').val(arrayInfo[0].registroutsup)

		$('#fecha17').val(arrayInfo[0].fechautqaqc)
		$('#hora17').val(arrayInfo[0].horautqaqc)
		$('#nombre17').val(arrayInfo[0].nombreutqaqc)

		if (arrayInfo[0].fechautqaqc != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroutqaqc);
			document.querySelector("#firma17").src = firmaUsuario
			$('#firma17').removeClass('oculto')
			$('#btnFirmar17').hide()
		}

		$('#registro17').val(arrayInfo[0].registroutqaqc)

        $('#fecha18').val(arrayInfo[0].fechaecpg)
		$('#hora18').val(arrayInfo[0].horaecpg)
		$('#nombre18').val(arrayInfo[0].nombreecpg)

		if (arrayInfo[0].fechaecpg != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroecpg);
			document.querySelector("#firma18").src = firmaUsuario
			$('#firma18').removeClass('oculto')
			$('#btnFirmar18').hide()
		}

		$('#registro18').val(arrayInfo[0].registroecpg)

		$('#fecha19').val(arrayInfo[0].fechaecp)
		$('#hora19').val(arrayInfo[0].horaecp)
		$('#nombre19').val(arrayInfo[0].nombreecp)

		if (arrayInfo[0].fechaecp != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroecp);
			document.querySelector("#firma19").src = firmaUsuario
			$('#firma19').removeClass('oculto')
			$('#btnFirmar19').hide()
		}

		$('#registro19').val(arrayInfo[0].registroecp)
    ...
    if (arrayDatos.liberacion != "") {
		...
		$('#numejecucion').val(arrayInfo[0].numejecucion)
    ...
    //CARGUE DE DATOS INTERNOS

    if (arrayDatos.internos != "") {

		arrayInfo = JSON.parse(arrayDatos.internos)


		$('#item1').val(arrayInfo[0].item1)
		$('#item2').val(arrayInfo[0].item2)
		$('#item3').val(arrayInfo[0].item3)
		$('#item4').val(arrayInfo[0].item4)
        $('#item5').val(arrayInfo[0].item5)
        ...
        $('#fecha37').val(arrayInfo[0].fechaecp)
		$('#hora37').val(arrayInfo[0].horaecp)
		$('#nombre37').val(arrayInfo[0].nombreecp)
		...
		$('#registro37').val(arrayInfo[0].registroecp)
		
        $('#fecha38').val(arrayInfo[0].fechaecp2)
		$('#hora38').val(arrayInfo[0].horaecp2)
		$('#nombre38').val(arrayInfo[0].nombreecp2)

		if (arrayInfo[0].fechaecp2 != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroecp2);
			document.querySelector("#firma38").src = firmaUsuario
			$('#firma38').removeClass('oculto')
			$('#btnFirmar38').hide()
		}

		$('#registro38').val(arrayInfo[0].registroecp2)
    ...
    if (arrayDatos.cierrem1 != "") {
		...
		$('#fecha39').val(arrayInfo[0].fechautsup)
		$('#hora39').val(arrayInfo[0].horautsup)
		$('#nombre39').val(arrayInfo[0].nombreutsup)
		...
		$('#registro39').val(arrayInfo[0].registroutsup)

		$('#fecha40').val(arrayInfo[0].fechaecp)
		$('#hora40').val(arrayInfo[0].horaecp)
		$('#nombre40').val(arrayInfo[0].nombreecp)
		...
		$('#registro40').val(arrayInfo[0].registroecp)
     ...
     if (arrayDatos.cierrem2 != "") {
		...
		$('#fecha42').val(arrayInfo[0].fechaecp)
		$('#hora42').val(arrayInfo[0].horaecp)
		$('#nombre42').val(arrayInfo[0].nombreecp)
		...
		$('#registro42').val(arrayInfo[0].registroecp)
    ...
    if (arrayDatos.ajustes != "") {
		...
		$('#fecha43').val(arrayInfo[0].fechautsup)
		$('#hora43').val(arrayInfo[0].horautsup)
		$('#nombre43').val(arrayInfo[0].nombreutsup)
		...
		$('#registro43').val(arrayInfo[0].registroutsup)

		$('#fecha44').val(arrayInfo[0].fechautqaqc)
		$('#hora44').val(arrayInfo[0].horautqaqc)
		$('#nombre44').val(arrayInfo[0].nombreutqaqc)
		...
		$('#registro44').val(arrayInfo[0].registroutqaqc)

        $('#fecha45').val(arrayInfo[0].fechaecpg)
		$('#hora45').val(arrayInfo[0].horaecpg)
		$('#nombre45').val(arrayInfo[0].nombreecpg)
		...
		$('#registro45').val(arrayInfo[0].registroecpg)
    ...
    if (arrayDatos.terminacion != "") {
		...
		$('#fecha46').val(arrayInfo[0].fechautsup)
		$('#hora46').val(arrayInfo[0].horautsup)
		$('#nombre46').val(arrayInfo[0].nombreutsup)

		if (arrayInfo[0].fechautsup != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroutsup);
			document.querySelector("#firma46").src = firmaUsuario
			$('#firma46').removeClass('oculto')
			$('#btnFirmar46').hide()
		}

		$('#registro46').val(arrayInfo[0].registroutsup)

		$('#fecha47').val(arrayInfo[0].fechautqaqc)
		$('#hora47').val(arrayInfo[0].horautqaqc)
		$('#nombre47').val(arrayInfo[0].nombreutqaqc)

		if (arrayInfo[0].fechautqaqc != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroutqaqc);
			document.querySelector("#firma47").src = firmaUsuario
			$('#firma47').removeClass('oculto')
			$('#btnFirmar47').hide()
		}

		$('#registro47').val(arrayInfo[0].registroutqaqc)

        $('#fecha48').val(arrayInfo[0].fechaecpg)
		$('#hora48').val(arrayInfo[0].horaecpg)
		$('#nombre48').val(arrayInfo[0].nombreecpg)

		if (arrayInfo[0].fechaecpg != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroecpg);
			document.querySelector("#firma48").src = firmaUsuario
			$('#firma48').removeClass('oculto')
			$('#btnFirmar48').hide()
		}

		$('#registro48').val(arrayInfo[0].registroecpg)
    ...
    if (arrayDatos.aplicacion != "") {
		...
		$('#fecha49').val(arrayInfo[0].fechautsup)
		$('#hora49').val(arrayInfo[0].horautsup)
		$('#nombre49').val(arrayInfo[0].nombreutsup)

		if (arrayInfo[0].fechautsup != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroutsup);
			document.querySelector("#firma49").src = firmaUsuario
			$('#firma49').removeClass('oculto')
			$('#btnFirmar49').hide()
		}

		$('#registro49').val(arrayInfo[0].registroutsup)

		$('#fecha50').val(arrayInfo[0].fechautqaqc)
		$('#hora50').val(arrayInfo[0].horautqaqc)
		$('#nombre50').val(arrayInfo[0].nombreutqaqc)

		if (arrayInfo[0].fechautqaqc != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroutqaqc);
			document.querySelector("#firma50").src = firmaUsuario
			$('#firma50').removeClass('oculto')
			$('#btnFirmar50').hide()
		}

		$('#registro50').val(arrayInfo[0].registroutqaqc)

        $('#fecha51').val(arrayInfo[0].fechaecpg)
		$('#hora51').val(arrayInfo[0].horaecpg)
		$('#nombre51').val(arrayInfo[0].nombreecpg)

		if (arrayInfo[0].fechaecpg != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroecpg);
			document.querySelector("#firma51").src = firmaUsuario
			$('#firma51').removeClass('oculto')
			$('#btnFirmar51').hide()
		}

		$('#registro51').val(arrayInfo[0].registroecpg)
    ...
    if (arrayDatos.entrega != "") {
		...
		$('#fecha52').val(arrayInfo[0].fechaecp)
		$('#hora52').val(arrayInfo[0].horaecp)
		$('#nombre52').val(arrayInfo[0].nombreecp)

		if (arrayInfo[0].fechaecp != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroecp);
			document.querySelector("#firma52").src = firmaUsuario
			$('#firma52').removeClass('oculto')
			$('#btnFirmar52').hide()
		}

		$('#registro52').val(arrayInfo[0].registroecp)

		$('#fecha53').val(arrayInfo[0].fechautsup)
		$('#hora53').val(arrayInfo[0].horautsup)
		$('#nombre53').val(arrayInfo[0].nombreutsup)

		if (arrayInfo[0].fechautsup != "") {
            var firmaUsuario = buscarFirma(arrayInfo[0].registroutsup);
			document.querySelector("#firma53").src = firmaUsuario
			$('#firma53').removeClass('oculto')
			$('#btnFirmar53').hide()
		}

		$('#registro53').val(arrayInfo[0].registroutsup)
...
function actInstalacion() {
    ...
    $.post(server + 'actOs3319Instalacion.php', {
        ods: odsq,
        tag: tag,
...
function actApertura() {
    ...
    $.post(server + 'actOs3319Apertura.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function actLimpieza() {
    ...
    $.post(server + 'actOs3319Limpieza.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function actInspeccion() {
    ...
    $.post(server + 'actOs3319Inspeccion.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function actMantenimiento() {
    ...
    itemmtto1 = $('#itemmtto1').val()
    itemmtto2 = $('#itemmtto2').val()
    itemmtto3 = $('#itemmtto3').val()
    itemmtto4 = $('#itemmtto4').val()
    itemmtto5 = $('#itemmtto5').val()
    itemmtto6 = $('#itemmtto6').val()
    itemmtto7 = $('#itemmtto7').val()
    itemmtto8 = $('#itemmtto8').val()

    cambioval1 = $('#cambioval1').val()
    cambioval2 = $('#cambioval2').val()
    cambioval3 = $('#cambioval3').val()
    cambioval4 = $('#cambioval4').val()

    //supervisor
    var fechautsup = $('#fecha16').val()
    var horautsup = $('#hora16').val()
    var nombreutsup = $('#nombre16').val()

    //var img = document.getElementById("firma1");
    var firmautsup = $('#registro16').val()

    if (fechautsup == '') {
        firmautsup = ''
    }

    var registroutsup = $('#registro16').val()

    //qaqc
    var fechautqaqc = $('#fecha17').val()
    var horautqaqc = $('#hora17').val()
    var nombreutqaqc = $('#nombre17').val()

    //var img = document.getElementById("firma2");
    var firmautqaqc = $('#registro17').val()

    if (fechautqaqc == '') {
        firmautqaqc = ''
    }

    var registroutqaqc = $('#registro17').val()

     //gestor tecnico ecopetrol
     var fechaecpg = $('#fecha18').val()
     var horaecpg = $('#hora18').val()
     var nombreecpg = $('#nombre18').val()
 
     //var img = document.getElementById("firma1");
     var firmaecpg = $('#registro18').val()
 
     if (fechaecpg == '') {
         firmaecpg = ''
     }
 
     var registroecpg = $('#registro18').val()
 
     //inspector ecopetrol
     var fechaecp = $('#fecha19').val()
     var horaecp = $('#hora19').val()
     var nombreecp = $('#nombre19').val()
 
     //var img = document.getElementById("firma2");
     var firmaecp = $('#registro19').val()
 
     if (fechaecp == '') {
         firmaecp = ''
     }
 
     var registroecp = $('#registro19').val()
    ...
    arrayInfo.push({
        ...
        "itemmtto7": itemmtto7,
        "itemmtto8": itemmtto8,
        "cambioval1": cambioval1,
        "cambioval2": cambioval2,
        "cambioval3": cambioval3,
        "cambioval4": cambioval4,
        "fechautsup": fechautsup,
        "horautsup": horautsup,
        "nombreutsup": nombreutsup,
        "firmautsup": firmautsup,
    ...
    $.post(server + 'actOs3319Mantenimiento.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function actLiberacion() {
	...
	var numejecucion = $('#numejecucion').val()
	...
	$.post(server + 'actOs3319Liberacion.php', {
		ods: odsq,
		tag: tag,
		datos: JSON.stringify(arrayInfo)
	},
...
function actComponentes() {
	...
	$.post(server + 'actOs3319Componentes.php', {
		ods: odsq,
		tag: tag,
...
function actInternos() {
    ...
    var registroutqaqc = $('#registro36').val()
     ...
     //inspector ecopetrol
     var fechaecp = $('#fecha37').val()
     var horaecp = $('#hora37').val()
     var nombreecp = $('#nombre37').val()
 
     //var img = document.getElementById("firma1");
     var firmaecp = $('#registro37').val()
 
     if (fechaecp == '') {
         firmaecp = ''
     }
 
     var registroecp = $('#registro37').val()
 
     //ingeniro procesos ecopetrol
     var fechaecp2 = $('#fecha38').val()
     var horaecp2 = $('#hora38').val()
     var nombreecp2 = $('#nombre38').val()
 
     //var img = document.getElementById("firma2");
     var firmaecp2 = $('#registro38').val()
 
     if (fechaecp2 == '') {
         firmaecp2 = ''
     }
 
     var registroecp2 = $('#registro38').val()
    ...
    arrayInfo.push({
        ...
        "fechaecp2": fechaecp2,
        "horaecp2": horaecp2,
        "nombreecp2": nombreecp2,
        "firmaecp2": firmaecp2,
        "registroecp2": registroecp2
    })

    console.log(arrayInfo)

    $.post(server + 'actOs3319Internos.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function actCierreM1() {
    ...
    //supervisor
    var fechautsup = $('#fecha39').val()
    var horautsup = $('#hora39').val()
    var nombreutsup = $('#nombre39').val()

    //var img = document.getElementById("firma1");
    var firmautsup = $('#registro39').val()

    if (fechautsup == '') {
        firmautsup = ''
    }

    var registroutsup = $('#registro39').val()

    //operciones ecopetrol
    var fechaecp = $('#fecha40').val()
    var horaecp = $('#hora40').val()
    var nombreecp = $('#nombre40').val()

    //var img = document.getElementById("firma2");
    var firmaecp = $('#registro40').val()

    if (fechaecp == '') {
        firmaecp = ''
    }

    var registroecp = $('#registro40').val()
    ...
    $.post(server + 'actOs3319CierreM1.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function actCierreM2() {
    ...
    //operciones ecopetrol
    var fechaecp = $('#fecha42').val()
    var horaecp = $('#hora42').val()
    var nombreecp = $('#nombre42').val()

    //var img = document.getElementById("firma2");
    var firmaecp = $('#registro42').val()

    if (fechaecp == '') {
        firmaecp = ''
    }

    var registroecp = $('#registro42').val()
    ...
    $.post(server + 'actOs3319CierreM2.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function actAjustes() {
    ...
    //supervisor
    var fechautsup = $('#fecha43').val()
    var horautsup = $('#hora43').val()
    var nombreutsup = $('#nombre43').val()

    //var img = document.getElementById("firma1");
    var firmautsup = $('#registro43').val()

    if (fechautsup == '') {
        firmautsup = ''
    }

    var registroutsup = $('#registro43').val()

    //qaqc
    var fechautqaqc = $('#fecha44').val()
    var horautqaqc = $('#hora44').val()
    var nombreutqaqc = $('#nombre44').val()

    //var img = document.getElementById("firma2");
    var firmautqaqc = $('#registro44').val()

    if (fechautqaqc == '') {
        firmautqaqc = ''
    }

    var registroutqaqc = $('#registro44').val()

    //gestor ecopetrol
    var fechaecpg = $('#fecha45').val()
    var horaecpg = $('#hora45').val()
    var nombreecpg = $('#nombre45').val()

    //var img = document.getElementById("firma2");
    var firmaecpg = $('#registro45').val()

    if (fechaecpg == '') {
        firmaecpg = ''
    }

    var registroecpg = $('#registro45').val()
    ...
    $.post(server + 'actOs3319Ajustes.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function actTerminacion() {
    ...
    //supervisor
    var fechautsup = $('#fecha46').val()
    var horautsup = $('#hora46').val()
    var nombreutsup = $('#nombre46').val()

    //var img = document.getElementById("firma1");
    var firmautsup = $('#registro46').val()

    if (fechautsup == '') {
        firmautsup = ''
    }

    var registroutsup = $('#registro46').val()

    //qaqc
    var fechautqaqc = $('#fecha47').val()
    var horautqaqc = $('#hora47').val()
    var nombreutqaqc = $('#nombre47').val()

    //var img = document.getElementById("firma2");
    var firmautqaqc = $('#registro47').val()

    if (fechautqaqc == '') {
        firmautqaqc = ''
    }

    var registroutqaqc = $('#registro47').val()

    //gestor ecopetrol
    var fechaecpg = $('#fecha48').val()
    var horaecpg = $('#hora48').val()
    var nombreecpg = $('#nombre48').val()

    //var img = document.getElementById("firma2");
    var firmaecpg = $('#registro48').val()

    if (fechaecpg == '') {
        firmaecpg = ''
    }

    var registroecpg = $('#registro48').val()
    ...
    $.post(server + 'actOs3319Terminacion.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function actAplicacion() {
    ...
    //supervisor
    var fechautsup = $('#fecha49').val()
    var horautsup = $('#hora49').val()
    var nombreutsup = $('#nombre49').val()

    //var img = document.getElementById("firma1");
    var firmautsup = $('#registro49').val()

    if (fechautsup == '') {
        firmautsup = ''
    }

    var registroutsup = $('#registro49').val()

    //qaqc
    var fechautqaqc = $('#fecha50').val()
    var horautqaqc = $('#hora50').val()
    var nombreutqaqc = $('#nombre50').val()

    //var img = document.getElementById("firma2");
    var firmautqaqc = $('#registro50').val()

    if (fechautqaqc == '') {
        firmautqaqc = ''
    }

    var registroutqaqc = $('#registro50').val()

    //gestor ecopetrol
    var fechaecpg = $('#fecha51').val()
    var horaecpg = $('#hora51').val()
    var nombreecpg = $('#nombre51').val()

    //var img = document.getElementById("firma2");
    var firmaecpg = $('#registro51').val()

    if (fechaecpg == '') {
        firmaecpg = ''
    }

    var registroecpg = $('#registro51').val()
    ...
    $.post(server + 'actOs3319Aplicacion.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function actEntrega() {
    ...
    //gestor ecopetrol
    var fechaecp = $('#fecha52').val()
    var horaecp = $('#hora52').val()
    var nombreecp = $('#nombre52').val()

    //var img = document.getElementById("firma2");
    var firmaecp = $('#registro52').val()

    if (fechaecp == '') {
        firmaecp = ''
    }

    var registroecp = $('#registro52').val()

    //supervisor
    var fechautsup = $('#fecha53').val()
    var horautsup = $('#hora53').val()
    var nombreutsup = $('#nombre53').val()

    //var img = document.getElementById("firma1");
    var firmautsup = $('#registro53').val()

    if (fechautsup == '') {
        firmautsup = ''
    }

    var registroutsup = $('#registro53').val()
    ...
    $.post(server + 'actOs3319Entrega.php', {
        ods: odsq,
        tag: tag,
        datos: JSON.stringify(arrayInfo)
    },
...
function adjuntar() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: server + 'guardarArchivo3319.php',
                type: 'post',
                data: formData,
                contentType: false,
                processData: false,
