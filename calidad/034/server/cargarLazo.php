...
$query="SELECT * FROM obsLazos WHERE ods='$ods' AND isometrico = '$tag' AND lazo = '$lazo'";
...
$sql="SELECT * FROM osLazos WHERE ods='$ods' AND isometrico = '$tag' AND lazo = '$lazo' ORDER BY item";
