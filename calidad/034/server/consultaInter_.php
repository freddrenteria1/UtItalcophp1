...
$catpermfirm = mysqli_num_rows($ejec);
...
$cons = "SELECT * FROM os38  WHERE " . $campo . " LIKE '%\"firmautsup\":\"data:image/png;%'"   .  ' AND  ' . $campo . " LIKE '%\"firmautqaqc\":\"data:image/png;%'"  .  ' AND  ' . $campo . " LIKE '%\"firmaec\":\"data:image/png;%'"; 
$ejec = mysqli_query($conexion, $cons);
$cantlibpartesfirm = mysqli_num_rows($ejec);
...
$cons = "SELECT * FROM os38  WHERE " . $campo . " LIKE '%\"firmautsup\":\"data:image/png;%'"   .  ' AND  ' . $campo . " LIKE '%\"firmautqaqc\":\"data:image/png;%'"  .  ' AND  ' . $campo . " LIKE '%\"firmaec\":\"data:image/png;%'"; 
$ejec = mysqli_query($conexion, $cons);
$cantlibhazfirm = mysqli_num_rows($ejec);
