...
while($row = mysqli_fetch_object($exito)){
    ...
    while($obj = mysqli_fetch_object($exito2)){
        ...
        $query = "INSERT INTO osLazos VALUES('', 'U-2100', 'TOPPING 2100', '030', '$lazo', '$isometrico', $item, '', '', '', '$actividad', '$firma')";
        $eje = mysqli_query($conexion, $query);

    }

    $query2 = "INSERT INTO obsLazos VALUES('', '030', '$isometrico', '$lazo', '', '')";
    $eje2 = mysqli_query($conexion, $query2);

    // $query3 = "INSERT INTO tags VALUES('', '028', 'U-2500', 'DEMEX', 'TUBERÍA', 'LAZOS DE CORROSIÓN', 'ALISTAMIENTO', '$lazo', '$isometrico', 'OS022-31')";
