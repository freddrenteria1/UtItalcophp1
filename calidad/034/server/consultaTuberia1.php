...
$totalequipos = $cantmisctub + $cantingenierias + $cantlazos;
$totalitalcoplan = $totalmisctubut + $totalingut + $totallazosut;
$totalecoplan = $totalmisctubec + $totalingec + $totallazosec;
$totalitalcoeje = $totalmisctubuteje + $totalinguteje + $totallazosuteje;
$totalecoeje = $totalmisctubeceje + $totalingeceje + $totallazoseceje;
