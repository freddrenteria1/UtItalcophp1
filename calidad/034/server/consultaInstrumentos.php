...
for ($i=0; $i<$sumcant;$i++){
    ...
    while($row = mysqli_fetch_object($exito)){
        ...
        $cons1 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaut\":\"data:image/jpg;%'";
        $ejec1 = mysqli_query($conexion, $cons1);
        $enc1 = mysqli_num_rows($ejec1);

        $sumfirmaut += $enc1;

        $cons1 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaut1\":\"data:image/jpg;%'";
        $ejec1 = mysqli_query($conexion, $cons1);
        $enc1 = mysqli_num_rows($ejec1);

        $sumfirmaut += $enc1;

        $cons1 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaut2\":\"data:image/jpg;%'";
        $ejec1 = mysqli_query($conexion, $cons1);
        $enc1 = mysqli_num_rows($ejec1);

        $sumfirmaut += $enc1*2;

        $cons1 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaut\":\"data:image/jpeg;%'";
        $ejec1 = mysqli_query($conexion, $cons1);
        $enc1 = mysqli_num_rows($ejec1);

        $sumfirmaut += $enc1;

        $cons1 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaut1\":\"data:image/jpeg;%'";
        $ejec1 = mysqli_query($conexion, $cons1);
        $enc1 = mysqli_num_rows($ejec1);

        $sumfirmaut += $enc1;

        $cons1 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaut2\":\"data:image/jpeg;%'";
        $ejec1 = mysqli_query($conexion, $cons1);
        $enc1 = mysqli_num_rows($ejec1);
        ...
        $cons2 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaec\":\"data:image/jpg;%'";
        $ejec2 = mysqli_query($conexion, $cons2);
        $enc2 = mysqli_num_rows($ejec2);
    
        $sumfirmaec += $enc2;

        $cons2 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaec1\":\"data:image/jpg;%'";
        $ejec2 = mysqli_query($conexion, $cons2);
        $enc2 = mysqli_num_rows($ejec2);
    
        $sumfirmaec += $enc2;

        $cons2 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaec2\":\"data:image/jpg;%'";
        $ejec2 = mysqli_query($conexion, $cons2);
        $enc2 = mysqli_num_rows($ejec2);
        ...
        $cons2 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaec\":\"data:image/jpeg;%'";
        $ejec2 = mysqli_query($conexion, $cons2);
        $enc2 = mysqli_num_rows($ejec2);
    
        $sumfirmaec += $enc2;

        $cons2 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaec1\":\"data:image/jpeg;%'";
        $ejec2 = mysqli_query($conexion, $cons2);
        $enc2 = mysqli_num_rows($ejec2);
    
        $sumfirmaec += $enc2;

        $cons2 = "SELECT * FROM "  . $tabla . "  WHERE familia =   '" . $familia . "'  AND  " . $campo . " LIKE '%\"firmaec2\":\"data:image/jpeg;%'";
        $ejec2 = mysqli_query($conexion, $cons2);
        $enc2 = mysqli_num_rows($ejec2);
