...
$consulta = "SELECT * FROM docprov WHERE user = '$user'";
...
if($enc == 0){
    ...
    if($archivo1 != ""){
        $sql = "UPDATE docprov SET file1='$archivo1' WHERE user = '$user'";
        $guardar = mysqli_query($conexion, $sql);
    }
    if($archivo2 != ""){
        $sql = "UPDATE docprov SET file2='$archivo2' WHERE user = '$user'";
        $guardar = mysqli_query($conexion, $sql);
    }
    if($archivo3 != ""){
        $sql = "UPDATE docprov SET file3='$archivo3' WHERE user = '$user'";
        $guardar = mysqli_query($conexion, $sql);
    }
    if($archivo4 != ""){
        $sql = "UPDATE docprov SET file4='$archivo4' WHERE user = '$user'";
        $guardar = mysqli_query($conexion, $sql);
    }
    if($archivo5 != ""){
        $sql = "UPDATE docprov SET file5='$archivo5' WHERE user = '$user'";
        $guardar = mysqli_query($conexion, $sql);
    }
    if($archivo6 != ""){
        $sql = "UPDATE docprov SET file6='$archivo6' WHERE user = '$user'";
        $guardar = mysqli_query($conexion, $sql);
    }
