        ...
        function cargarListaOM(){
            ...
            function(resp){
                ...
                if(resp != null){
                    ...
                    html += `
                            <div class="btnom  mr-2">
                                <button class="btn btn-success btn-lg btn-block" onclick="agregarOM()">AGREGAR</button>
                                
                            </div>
                            <div class="btnom  mr-2">
                            <button class="btn btn-danger btn-lg ml-1 btn-block" onclick="borrarOM()">BORRAR</button>
        ...
        function mostrarArchivos(numom){
            ...
            $.post(server+'verFilesOM.php',{semana:semana, frente:frente, om:numom},
            function(resp){
                arrayFiles = resp
