        ...
        function solOM(){
            ...
            Swal.fire({
                title: "OM a consultar",
                html: `
                <p><input type="number" id="ombuscar"> </p>
                `,
                showCancelButton: true,
                confirmButtonText: "Cosultar",
                cancelButtonText: `Cancelar`,
                ...
                /* Read more about isConfirmed, isDenied below */
                if (result.isConfirmed) {
                    var numomb = $('#ombuscar').val()
                    
                    mostrarArchivos(numomb)
        ...
        function veriAdmin() {
            Swal.fire({
                ...
                if (useradmin == 'calidad031@utitalco.com' && claveadmin == 'italco2024*') {
        ...
        function cargarListaOM(){
            console.log(frente)
            console.log(semana)
            $.post(server+'verOMFrente.php',{frente:frente, semana:semana},
            function(resp){
                arrayOm = resp
        ...
        function cargarLOM(frenteb){
            $('#archivossem').html('')
            $('#numom').html('Seleccione una Orden de Mantenimiento')
            frente = frenteb
            console.log(frente)
            console.log(numsem)
        ...
        function mostrarArchivos(numom){
            ...
            $.post(server+'verFilesOM.php',{om:numom},
            function(resp){
                    ...
                    for(var i=0; i<arrayFiles.length; i++){
                        html += `
                            <div class="doc">
                                ...
                                <div class="borrar" onclick="borrarFilesDiarios('${arrayFiles[i].id}')">
                                    X
                                </div>
                            </div>
                        `
