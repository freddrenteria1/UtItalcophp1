const API = "https://utitalco.com/hse/hitos/030/server/";
const DIRECTORIO = "https://utitalco.com/hse/hitos/030/archivos/";
  ...
  methods: {
    ...
    async cargarDatos() {
      ...
      try {
        ...
        var totavance = eje + rev + apro;

        plan = data.length;

        avance = (totavance / plan) * 100;
    ...
    cargarGraficas() {
      Highcharts.chart("fig", {
        ...
        title: {
          text: "<b>PLANEADOS VS ELABORADOS</b>",
        },
        ...
        series: [{
            name: "Permisos Planeados",
            data: [this.plan],
          },
          {
            name: "Permisos Elaborados",
            data: [this.eje],
          }
        ],
      });
      ...
      Highcharts.chart("fig3", {
        ...
        title: {
          text: "<b>PERMISOS ELABORAS POR CLASIFICACIÓN</b>",
        },
      ...
      Highcharts.chart("fig2", {
        ...
        title: {
          text: "<b>PROCEDIMIENTOS DE RESCATES REALIZADOS</b>",
        },
