const API = "https://utitalco.com/hse/hitos/035/server/";
const DIRECTORIO = "https://utitalco.com/hse/hitos/035/archivos/";
...
const app = Vue.createApp({
  ...
  methods: {
    ...
    async cambiarItem(id) {

      await Swal.fire({
        title: "Cambiar Item",
        html: `
                <input type="number" class="form-control" placeholder="# Item" id="item">
        ...
        if (result.value) {
          ...
          $.post(API+'actItems.php',{item:item,id:id},
            function(resp){
              console.log('respuestas de items')
              console.log(resp)
              Swal.fire({
                position: "top-end",
                icon: "success",
