...
const app = Vue.createApp({
    ...
    methods: {
        ...
        async actInfoBasica() {
            ...
            if (this.tipodoc && this.doc && this.depdoc && this.mundoc && this.fdoc && this.email && this.estcivil && this.fnac && this.nombres && this.sexo && this.tel && this.nacionalidad && this.depnac && this.municipionac && this.depresidencia && this.municipiores && this.barrio && this.otrotel && this.dir && this.perfil && this.sitlabact && this.proptransp && this.numhijos && this.rangohijos && this.cabfam && this.pobvul != '' && this.gruposangre != '' && this.emergencia != '' && this.numemergencia != '') {
        ...
        descargarAnexos() {
            window.open('https://utitalco.com/hvc/FORMATOS ANEXOS PARA CONTRATACION.pdf', '_blank');
        },

        descargarGab() {
            window.open('https://utitalco.com/hvc/GAB-F-214 Certificación cumplimiento de perfiles ECP V2.xls', '_blank');
        },
