...
$cadena = 'hitopersonalproy' . $ods . $fecha;
...
$sql = "DELETE FROM pesonalproy WHERE ods='$ods' and fecha = '$fecha'";
...
while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
    ...
    if ($numeroDeFila > 1) {
        ...
        $query = "INSERT INTO pesonalproy VALUES('', '$fila[0]', $fila[1], $fila[2], $fila[3], '$fecha', '$ods')";
