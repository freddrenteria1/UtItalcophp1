...
$ods = $_POST["ods"];
$sk = $_POST["sk"];
$informe = $_POST["numinforme"];
$fechainforme = $_POST["fechainforme"];

$cadena = 'pruebatt' . $ods . $sk . $fecha;
...
$sql = "DELETE FROM pruebatermica WHERE ods='$ods' and sk = '$sk' and fecha = '$fechainforme'";
...
while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
    ...
    if ($numeroDeFila > 2) {
        ...
        if($fila[0] != ""){
            ...
            $query = "INSERT INTO pruebatermica VALUES('', '$fechainforme', '$ods', '$informe', '$sk', '$fila[0]', '$fila[1]', '$fila[2]')";
