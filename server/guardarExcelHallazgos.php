...
$sql = "DELETE FROM hallazgos WHERE ods='$ods'";
...
while (($fila = fgetcsv($gestor, $longitudDeLinea, $delimitador, $caracterCircundante)) !== false) {
    ...
    if ($numeroDeFila > 1) {
        ...
        $query = "INSERT INTO hallazgos VALUES('', '$fila[0]', '$fila[1]', '$fila[2]', '$fila[3]', '$fila[4]', '$fila[6]', '$fila[5]', '$fila[8]', '$fila[9]',  '$fila[7]', '$ods')";
