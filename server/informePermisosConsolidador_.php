...
//SE BUSCAN AGRUPAN LOS ALCANCES DEL HITO
    ...
    $sql="SELECT * FROM permisostrab WHERE frente = '$frente' AND fecha>='$finicio' AND fecha<='$ffin'";
    ...
    while ($row = mysqli_fetch_object($exito)){
        ...
        if($esp == 'MECANICO ROTATIVOS'){
            $espmecarota++;
        }
        if($esp == 'MECANICO - TUBERIA'){
            $espemecatub++;
        }
        if($esp == 'QA-QC'){
            $espqaqc++;
        }
        if($esp == 'ENSAYOS NO DESTRUCTIVOS'){
            $espend++;
        }
    ...
    $datos = array(
        ...
        'espinst'=>$espinst,
        'esppint'=>$esppint,
        'espestatico'=>$espestatico,
        'esplavado'=>$esplavado,
        'espmecarota'=>$espmecarota,
        'espemecatub' => $espemecatub,
        'espqaqc' => $espqaqc,
        'espend' => $espend,
        'tabla'=>$tabla
    );
