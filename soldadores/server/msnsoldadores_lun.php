<?php 
	...
	$sel="SELECT * FROM soldadores Where fecha = '2023-05-05'";
	...
	if ($cont!=0){
        ...
        while ($obj = mysqli_fetch_object($busq)){
            ...
            $mensaje ="UT Italco ha reprogramado las calificaciones para el sábado y lunes. Elija la hora aquí https://utitalco.com/soldadores/";
