<?php 
	...
	$sel="SELECT * FROM soldadores Where fecha = '2023-06-02'";
	...
	if ($cont!=0){
        ...
        while ($obj = mysqli_fetch_object($busq)){
            ...
            $mensaje ="UT Italco ha reprogramado las calificaciones para el sábado. Actualice la hora aquí https://utitalco.com/soldadores/";
