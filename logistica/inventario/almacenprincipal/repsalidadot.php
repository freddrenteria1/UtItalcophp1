...
<body>
    ...
    <main>
                ...
                <div class="container">
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        <a href="/" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                            ...
                            <h3 class="tit">Almacén Consumibles ODS <span id="numods"></span> </h3>
                        </a>
        ...
        <div class="container mt-3">
            <h3>Reporte Remisiones Entrega de Dotación
            </h3>
            <hr>
            <div class="cuerpo">
    ...
    <script>
        ...
        var url = 'https://utitalco.com/logistica/inventario/server/'

        cargarEntradas()

        function cargarEntradas() {
            $.post(url + 'cargarSalidasConsu.php',
                function(resp) {
                    arrayDatos = resp
                    if (arrayDatos != null) {
                        var html = ''
                        for (var i = 0; i < arrayDatos.length; i++) {
                            html += `
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success" onClick="ver('${i}')">Ver</button>    
                                    </td>
                                </tr>
                            `
                        }
        ...
        function ver(i) {
            var ident = arrayDatos[i].id;
            location = "versalida.html?id=" + ident
        }
