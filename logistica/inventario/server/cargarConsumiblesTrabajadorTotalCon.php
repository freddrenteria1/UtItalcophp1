...
$query = "SELECT *, SUM(cant) AS totitems FROM consutemp WHERE fecha BETWEEN '$inicio'  AND '$fin' AND ods = '$ods' GROUP BY cod";
$eje = mysqli_query($conexion, $query);
...
// $query5 = "SELECT *, SUM(cant) AS totitems FROM consutemp WHERE fecha BETWEEN '$inicio'  AND '$fin' AND ods = '$ods' GROUP BY ced, cod";
// $eje5 = mysqli_query($conexion, $query5);

// while($obj1 = mysqli_fetch_object($eje5)){
//     $cons[] = array(
//         'nombres'=>$obj1->nombres,
//         'ced'=>$obj1->ced,
//         'cargo'=>$obj1->cargo,
//         'ods'=>$obj1->ods,
//         'cant'=>$obj1->totitems,
