...
$sql = "INSERT INTO ordenentrada VALUES('','$fecha','$proveedor','$remision','$ordencompra','$ods','$items','$observaciones', '$archivo','$user')";
...
if(!$gent){
    ...
    for($i = 0; $i<$canti; $i++){
        ...
        if($enc != 0){
            ...
            $query2 = "INSERT INTO inventario VALUES('', '$tipo', '$codtipo', '$clase', '$codclase','$articulo','$cod', '$unidad', $cant, $precio, 'AP','Existente')";
