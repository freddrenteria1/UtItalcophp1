...
if($ced != '' && $items != ''){
    ...
    for($i = 0; $i<$canti; $i++){
        ...
        $buscar = "SELECT * FROM invactivos Where codigo = '$cod' And ced = '$ced' And ods='$odstrab'";
        ...
        if($cantb > 0){
            ...
            $query2 = "UPDATE invactivos SET cant = $ncant Where codigo = '$cod' And ced = '$ced'  And ods='$odstrab'";
