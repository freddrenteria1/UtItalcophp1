...
const app = Vue.createApp({
    ...
    methods: {
        ...
        async actInfoBasica() {
            ...
            if (this.tipodoc && this.doc && this.depdoc && this.mundoc && this.fdoc && this.email && this.estcivil && this.fnac && this.nombres && this.sexo && this.tel && this.nacionalidad && this.depnac && this.municipionac && this.depresidencia && this.municipiores && this.barrio && this.otrotel && this.dir && this.perfil && this.sitlabact && this.proptransp && this.numhijos && this.cabfam && this.pobvul && this.gruposangre && this.emergencia  && this.numemergencia != '') {
