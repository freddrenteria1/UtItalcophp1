...
const app = Vue.createApp({
    ...
    methods: {
        ...
        async cargarDatos() {
            Swal.fire({
                imageUrl: 'https://utitalco.com/hv/img/recuerde.png',
                imageHeight: 500,
                width: '700',
        ...
        async subir() {
            if (this.tipodocumento != "" && this.doc != "") {
        ...
        descargarFile(e) {
            //window.location.href = "https://utitalco.com/hv/server/archivos/"+e;
            window.open('https://utitalco.com/hv/server/archivos/' + e, '_blank');
        },
        ...
        descargarTratDatos(){
            window.open('https://utitalco.com/hv/TRATAMIENTO DE DATOS.pdf', '_blank');
        },

        descargarSeleccion(){
            window.open('https://utitalco.com/hv/PAQUETE DE SELECCIÓN.pdf', '_blank');
        },
